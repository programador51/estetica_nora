...
export async function GET(req: NextRequest) {
  const dbRecords: ServiceOption[] = [
    {
      ...
      id: 1,
      picture:
        "https://www.primor.eu/blog/wp-content/uploads/2023/11/CORTE-PELO-HOMBRE-1.jpg",
      costPrice: 20,
      sellPrice: 70,
    ...
    },
    {
      ...
      id: 2,
      picture:
        "https://estiloybelleza.com/blog/wp-content/uploads/2021/08/longbob1.jpg",
      costPrice: 50,
      sellPrice: 200,
    ...
    },
    {
      ...
      id: 3,
      picture:
        "https://resizer.sevilla.abc.es/resizer/resizer.php?imagen=https://sevilla.abc.es/estilo/bulevarsur/wp-content/uploads/sites/14/2022/01/productos-cuidar-rubio-platino-casa.jpg&nuevoancho=652",
      costPrice: 15,
      sellPrice: 25,
  ...
  try {
    ...
    return NextResponse.json(
      generateError(500, "No se pudo obtener los servicios", error),
      {
        status: 500,
      }
    );
